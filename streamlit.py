...
def main():
    ...
    humidity = st.slider('humidity', min_value=0.0, max_value=100.0, value=1)
    wind_speed = st.slider('wind_speed', min_value=0.0, max_value=20.0, value=0.01)
    wind_deg = st.slider('wind_deg', min_value=0.0, max_value=360.0, value=1)
    ...
    rain_12h = st.slider('rain_12h', min_value=0.0, max_value=250.0, value=1)
